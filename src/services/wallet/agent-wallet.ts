    ...
    getAddress: () =>
      Effect.tryPromise({
        try: async () => {
          ...
          new WalletError({
            message: `Failed to get agent wallet address: ${error}`,
            cause: error,
          }),
      }),
    ...
    sign: (message: string) =>
      Effect.tryPromise({
        try: async () => {
          ...
          new WalletError({
            message: `Failed to sign with agent wallet: ${error}`,
            cause: error,
          }),
      }),
    ...
    sendTransaction: (tx: SendTransactionParams) =>
      Effect.tryPromise({
        try: async () => {
          ...
          new WalletError({
            message: `Failed to send transaction from agent wallet: ${error}`,
            cause: error,
          }),
      }),
  };
